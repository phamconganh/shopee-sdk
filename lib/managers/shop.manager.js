...
export class ShopManager extends BaseManager {
     ...
     */
    async getBRShopOnboardingInfo(params) {
        const response = await ShopeeFetch.fetch(this.config, "/shop/get_br_shop_onboarding_info", {
            method: "GET",
            auth: true,
            params: params || {},
        });
     ...
     */
    async getShopHolidayMode(params) {
        const response = await ShopeeFetch.fetch(this.config, "/shop/get_shop_holiday_mode", {
            method: "GET",
            auth: true,
            params: params || {},
        });
     ...
     */
    async setShopHolidayMode(params) {
        const response = await ShopeeFetch.fetch(this.config, "/shop/set_shop_holiday_mode", {
            method: "POST",
            auth: true,
            body: params,
        });
