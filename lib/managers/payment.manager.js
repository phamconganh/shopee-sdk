...
export class PaymentManager extends BaseManager {
     ...
     */
    async getIncomeDetail(params) {
        const response = await ShopeeFetch.fetch(this.config, "/payment/get_income_detail", {
            method: "GET",
            auth: true,
            params,
        });
    ...
    async getIncomeOverview(params) {
        const response = await ShopeeFetch.fetch(this.config, "/payment/get_income_overview", {
            method: "GET",
            auth: true,
            params,
        });
